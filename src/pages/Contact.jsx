...
const Contact = () => {
  ...
  const pageStyle = {
    background: `linear-gradient(rgba(254, 247, 237, 0.9), rgba(240, 249, 255, 0.9)), url('https://images.pexels.com/photos/8828492/pexels-photo-8828492.jpeg?auto=compress&cs=tinysrgb&w=1600')`,
